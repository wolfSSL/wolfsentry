...
enum wolfsentry_error_id {
    ...
    WOLFSENTRY_ERROR_ID_NOT_INSERTED           =  20,
    WOLFSENTRY_ERROR_ID_DATA_MISSING           =  21,
    WOLFSENTRY_ERROR_ID_NOT_PERMITTED          =  22,
    WOLFSENTRY_ERROR_ID_ALREADY                =  23,
    WOLFSENTRY_ERROR_ID_CONFIG_INVALID_KEY     =  24,
    WOLFSENTRY_ERROR_ID_CONFIG_INVALID_VALUE   =  25,
    WOLFSENTRY_ERROR_ID_CONFIG_OUT_OF_SEQUENCE =  26,
    WOLFSENTRY_ERROR_ID_CONFIG_UNEXPECTED      =  27,
